...
export const Icon_Logo: React.FC<IconProjectsProps> = ({
  ...
  return (
    <svg
      ...
      height="20"
      viewBox="0 0 12 20"
      fill="var(--Primary-950, #352D48)"
      onClick={handleClick}
      className={className}
    >
      <path
        d="M0.539062 6.22609L6.76515 0V3.30435H11.4608V6.22609H6.76515V13.3913C6.76515 14.2029 6.89268 14.8754 7.14776 15.4087C7.42602 15.942 7.82022 16.3246 8.33037 16.5565C8.84051 16.7652 9.31587 16.9043 9.75645 16.9739C10.2202 17.0435 10.7883 17.0783 11.4608 17.0783V20C8.79413 20 6.82312 19.4899 5.54776 18.4696C4.2724 17.4493 3.63471 15.7565 3.63471 13.3913V6.22609H0.539062Z"
        fill="#352D48"
      />
    </svg>
  );
