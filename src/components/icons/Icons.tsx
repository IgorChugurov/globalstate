...
export const Icon_east: React.FC<IconProjectsProps> = ({
  ...
  return (
    ...
    >
      ...
      <g mask="url(#mask0_275_2553)">
        <path d="M10.0002 12.6666L9.05016 11.7333L12.1168 8.66659H1.3335V7.33325H12.1168L9.06683 4.26659L10.0002 3.33325L14.6668 7.99992L10.0002 12.6666Z" />
      </g>
    </svg>
  );
};
