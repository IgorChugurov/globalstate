                          ...
                          {selectedItems.length > 0 ? (
                            ...
                            >
                              {selectedItems.map((comp, i) => (
                                <span
                                  key={comp}
                                  className="body-s-regular colorGrey500 menuItemText"
                                >
                                  {options.find((c: any) => c._id === comp)
                                    ?.name ?? ""}
                            ...
                            <span className="body-s-regular colorGrey500 menuItemText">
                              {placeholder}
                            </span>
                          )}
                        </>
                    ...
                    {optioinsWithEmpty.map((r, i) => (
                      <MenuItem
                        ...
                        sx={{
                          ...
                          "&.Mui-selected": { backgroundColor: "primary.100" },
                        }}
                      >
                        {r.division === "YES" ? (
                          <>
                          ...
                          <>
                            <Checkbox
                              size="small"
                              checked={field.value.indexOf(r._id) > -1}
                            />
                            <span
                              className={[
                                "menuItemText",
